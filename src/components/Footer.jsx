    ...
    <footer className="bg-base-300 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm text-base-content/60 leading-relaxed">
              ShakibSchool is a premium course selling platform dedicated to
              providing the best learning resources for students.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-base-content/10 pt-8 text-center text-sm text-base-content/40">
          <p>© {new Date().getFullYear()} ShakibSchool. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
