...
export const metadata = {
  title: "About Us | ShakibSchool",
  description:
    "Discover ShakibSchool, your premium gateway to high-quality digital learning resources and professional courses.",
};
      ...
      <section className="relative py-20 bg-base-200 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 text-center relative z-10">
          <h1 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-6">
            We are <span className="text-primary">ShakibSchool</span>
          </h1>
          <p className="text-lg md:text-xl text-base-content/60 max-w-3xl mx-auto leading-relaxed font-medium">
            We believe that quality education and professional resources should
            be accessible to everyone. Our goal is to provide the perfect
            guidelines to take your expertise to the next level.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            {stats.map((stat, idx) => (
              <div
                key={idx}
                className="bg-base-100 border border-base-200 p-8 rounded-[2.5rem] shadow-xl text-center hover:border-primary/30 transition-all"
              >
            ...
            <div className="flex-1 order-2 md:order-1">
              <h2 className="text-3xl md:text-5xl font-black mb-6 uppercase tracking-tighter leading-tight">
                ...
                <span className="text-primary text-2xl md:text-4xl">
                  Modern Learners Everywhere
                </span>
              </h2>
              <p className="text-base-content/70 mb-8 leading-loose font-medium text-justify">
                ShakibSchool is more than just a marketplace; it is a premium
                platform dedicated to connecting ambitious learners with
                high-quality educational content. We understand the rapidly
                changing demands of the global market. Whether you are looking
                for technical mastery or creative skills, our library offers
                comprehensive materials to ensure your success in any field.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                <div className="badge badge-lg bg-base-200 border-none py-6 px-6 rounded-2xl font-bold gap-2 italic">
                  <ShieldCheck className="h-5 w-5 text-primary" /> Verified
                  Content
                </div>
              </div>
            </div>
      ...
      <section className="py-20 text-center">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-primary p-12 rounded-[3rem] text-primary-content">
            ...
            <p className="mb-8 opacity-80 font-medium text-lg">
              Join thousands of students today and take the first step towards
              mastering your future.
            </p>
            <div className="flex justify-center gap-4">
              <Link
                href={"/courses"}
                className="btn btn-neutral rounded-2xl px-10 font-black uppercase tracking-widest h-16 shadow-xl"
              >
                Browse All Courses
              </Link>
            </div>
